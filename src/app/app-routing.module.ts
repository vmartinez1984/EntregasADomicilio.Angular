...
const routes: Routes = [
  ...
  { path: "iniciarSesion", component: LoginComponent,  data: { titulo: "Inicio de sesión", etiqueta:'sesion' } },
  { path: "olvidoSuContrasenia", component: OlvidoDeContraseniaComponent,  data: { titulo: "Olvido su contraseña", etiqueta:'sesion' } },
